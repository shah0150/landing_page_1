    ...
    $(function() {
        ...
        if (navigator.userAgent.match(/iPhone|iPad|iPod|Android|BlackBerry|IEMobile/i)) {
            ...
            if (!!window.opera || navigator.userAgent.indexOf(' OPR/') >= 0) {
                BV.show('video_bg.ogv', {
                    doLoop: true,
                    ambient: true
                });
            } else {
                BV.show('video_bg.mp4', {
                    doLoop: true,
                    ambient: true,
                    altSource: 'video_bg.ogv'
                });
            }
        ...
        if ($(this).valid()) {
            ...
            $.ajax({
                ...
                success: function() {
                    ...
                    //Use modal popups to display messages
                    $('#modalMessage .modal-title').html('<i class="icon icon-envelope-open"></i>Your Message has been sent.</br>Thanks for reaching out to us!');
                    $('#modalMessage').modal('show');
                },
                error: function() {
                    $('#contact_submit').button('reset');
